// Class Inheritance
// Inheritance enables you to define a class that takes all the functionality from a parent class and allows you to 
// add more.
...
let student2 = new StudentA('Jack');
student1.greet();
...
// If a child class has the same method or property name as that of the parent class, it will use the method and 
// property of the child class. This concept is called method overriding. For example,
