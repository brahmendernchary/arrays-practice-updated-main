...
// The first parameter is just a string which is the name of the event to listen to. There are hundreds of events that you can listen to such as click, input, and mousemove. This is a complete list of events, but you will really only use a handful of these events so don't bother memorizing them all.
