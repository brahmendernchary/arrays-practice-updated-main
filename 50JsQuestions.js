...
console.log(
  "[ayushv.medium.com/](https://ayushv.medium.com/)" instanceof String
);
1;
...
const obj21 = { a: "one", b: "two", a: "three" };
console.log(obj21);
...
// Question 27:
const obj27 = { 1: "a", 2: "b", 3: "c" };
const set = new Set([1, 2, 3, 4, 5]);

obj27.hasOwnProperty("1");
obj27.hasOwnProperty(1);
set.has("1");
set.has(1);
...
// Question 30:
let person30 = { name: "Ayush" };
const members = [person30];
person = null;
...
// Question 38:
const arr38 = [1, 2, undefined, NaN, null, false, true, "", "abc", 3];
console.log(arr38.filter(Boolean));
1;

const arr39 = [1, 2, undefined, NaN, null, false, true, "", "abc", 3];
console.log(arr39.filter(!Boolean));
2;
// **Answer —
...
console.log(person39[25]);
console.log(person39[0.25e2]);
console.log(person39[".25e2"]);
